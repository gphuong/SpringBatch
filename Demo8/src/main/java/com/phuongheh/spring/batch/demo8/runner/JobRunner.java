package com.phuongheh.spring.batch.demo8.runner;

import com.phuongheh.spring.batch.demo8.utils.Constants;
...
public class JobRunner {
    ...
    @Autowired
    public JobRunner(Job demo8, JobLauncher jobLauncher) {
    ...
    public void runBatchJob() {
        ...
        runJob(demo8, jobParametersBuilder.toJobParameters());
    }
