package com.phuongheh.spring.batch.demo15.job;


import com.phuongheh.spring.batch.demo15.dto.EmployeeDTO;
import com.phuongheh.spring.batch.demo15.handler.SkipRecordCallback;
import com.phuongheh.spring.batch.demo15.mapper.EmployeeFileRowMapper;
import com.phuongheh.spring.batch.demo15.model.Employee;
import com.phuongheh.spring.batch.demo15.processor.EmployeeProcessor;
...
public class Demo15 {
    ...
    @Autowired
    public Demo15(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory, EmployeeProcessor employeeProcessor, DataSource dataSource) {
