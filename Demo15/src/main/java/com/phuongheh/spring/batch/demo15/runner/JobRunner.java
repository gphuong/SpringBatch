package com.phuongheh.spring.batch.demo15.runner;

import com.phuongheh.spring.batch.demo15.utils.Constants;
...
public class JobRunner {
    ...
    @Autowired
    public JobRunner(Job demo15, JobLauncher jobLauncher) {
    ...
    public void runBatchJob() {
        ...
        runJob(demo15, jobParametersBuilder.toJobParameters());
    }
