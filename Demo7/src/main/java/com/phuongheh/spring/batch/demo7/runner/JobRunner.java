package com.phuongheh.spring.batch.demo7.runner;

import com.phuongheh.spring.batch.demo7.utils.Constants;
...
public class JobRunner {
    ...
    @Autowired
    public JobRunner(Job demo7, JobLauncher jobLauncher) {
    ...
    public void runBatchJob() {
        ...
        runJob(demo7, jobParametersBuilder.toJobParameters());
    }
