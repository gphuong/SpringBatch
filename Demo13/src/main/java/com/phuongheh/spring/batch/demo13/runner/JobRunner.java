package com.phuongheh.spring.batch.demo13.runner;

import com.phuongheh.spring.batch.demo13.utils.Constants;
...
public class JobRunner {
    ...
    @Autowired
    public JobRunner(Job demo13, JobLauncher jobLauncher) {
    ...
    public void runBatchJob() {
        ...
        runJob(demo13, jobParametersBuilder.toJobParameters());
    }
