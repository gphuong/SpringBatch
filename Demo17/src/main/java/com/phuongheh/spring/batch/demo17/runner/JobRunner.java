package com.phuongheh.spring.batch.demo17.runner;

import com.phuongheh.spring.batch.demo17.utils.Constants;
...
public class JobRunner {
    ...
    @Autowired
    public JobRunner(Job demo17, JobLauncher jobLauncher) {
    ...
    public void runBatchJob() {
        ...
        runJob(demo17, jobParametersBuilder.toJobParameters());
    }
