package com.phuongheh.spring.batch.demo9.runner;

import com.phuongheh.spring.batch.demo9.utils.Constants;
...
public class JobRunner {
    ...
    @Autowired
    public JobRunner(Job demo9, JobLauncher jobLauncher) {
    ...
    public void runBatchJob() {
        ...
        runJob(demo9, jobParametersBuilder.toJobParameters());
    }
