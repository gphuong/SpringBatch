package com.phuongheh.spring.batch.demo16.runner;

import com.phuongheh.spring.batch.demo16.utils.Constants;
...
public class JobRunner {
    ...
    @Autowired
    public JobRunner(Job demo16, JobLauncher jobLauncher) {
    ...
    public void runBatchJob() {
        ...
        runJob(demo16, jobParametersBuilder.toJobParameters());
    }
