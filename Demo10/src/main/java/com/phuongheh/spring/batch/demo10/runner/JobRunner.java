package com.phuongheh.spring.batch.demo10.runner;

import com.phuongheh.spring.batch.demo10.utils.Constants;
...
public class JobRunner {
    ...
    @Autowired
    public JobRunner(Job demo10, JobLauncher jobLauncher) {
    ...
    public void runBatchJob() {
        ...
        runJob(demo10, jobParametersBuilder.toJobParameters());
    }
