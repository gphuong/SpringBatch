package com.phuongheh.batch.demo3.job;

import com.phuongheh.batch.demo3.dto.EmployeeDTO;
import com.phuongheh.batch.demo3.mapper.EmployeeDBRowMapper;
import com.phuongheh.batch.demo3.model.Employee;
import com.phuongheh.batch.demo3.processor.EmployeeProcessor;
...
public class Demo3 {
    ...
    @Autowired
    public Demo3(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory, DataSource dataSource, EmployeeProcessor employeeProcessor) {
    ...
    private ItemWriter<EmployeeDTO> employeeFileWriter() {
    ...
    private ItemStreamReader<Employee> employeeDBReader() {
