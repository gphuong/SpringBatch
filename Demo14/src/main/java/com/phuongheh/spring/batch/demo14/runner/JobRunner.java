package com.phuongheh.spring.batch.demo14.runner;

import com.phuongheh.spring.batch.demo14.utils.Constants;
...
public class JobRunner {
    ...
    @Autowired
    public JobRunner(Job demo14, JobLauncher jobLauncher) {
    ...
    public void runBatchJob() {
        ...
        runJob(demo14, jobParametersBuilder.toJobParameters());
    }
